...
/*   Updated: 2022/05/04 11:49:34 by pstengl          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->map.texture_north = load_texture(data->mlx, data->map.texture_north.filename);
	if (data->map.texture_north.data == NULL)
		error_message("Could not load texture north\n");
	data->map.texture_south = load_texture(data->mlx, data->map.texture_south.filename);
	if (data->map.texture_south.data == NULL)
		error_message("Could not load texture south\n");
	data->map.texture_east = load_texture(data->mlx, data->map.texture_east.filename);
	if (data->map.texture_east.data == NULL)
		error_message("Could not load texture east\n");
	data->map.texture_west = load_texture(data->mlx, data->map.texture_west.filename);
